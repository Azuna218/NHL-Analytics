...
# Plot the top provinces producing NHL players
...
team_birth_count <- head(team_birth_count,5)
...
sil_widths <- silhouette(kmeans_result$cluster, dist(clustering_data_scaled))

# Average silhouette width
mean_sil_width <- mean(sil_widths[, 3])
print(paste("Mean Silhouette Width:", mean_sil_width))

# Plot the silhouette
plot(sil_widths, main = "Silhouette Plot for K-Means Clustering")
